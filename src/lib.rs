// src/lib.rs
/*
 * Core library for PlatformioIde
 */
...
#[derive(Debug)]
pub struct PlatformioIdeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PlatformioIdeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PlatformioIde processing");
    
    let mut processor = PlatformioIdeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PlatformioIdeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PlatformioIdeProcessor::new(false);
